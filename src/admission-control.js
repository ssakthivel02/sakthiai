...
export function admissionPolicy(env={}){
  ...
  return {enabled:bool(env.ADMISSION_CONTROL_ENABLED),hardLimit,degradeAt:Math.max(1,Math.floor(hardLimit*degradePercent/100)),defaultDecision:'ADMIT',unknownCapacityBehavior:'FAIL_CLOSED_WHEN_ENABLED',paidFallback:false};
}
