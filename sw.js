const CACHE='sakthiai-hi-tech-v1-20260902';
const CORE=['./','./index.html','./assets/styles.css','./assets/capabilities.js','./assets/runtime.js','./assets/app.js','./manifest.webmanifest','./offline.html'];
